...
/*   Updated: 2025/08/24 13:29:59 by kyamanak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	split_head_tail(char *num_str, const char *scale,
	char **head, char **tail)
{
	int	head_len;
	int	tail_len;
...
static int	process_tail_if_needed(t_dict *dict, char *tail, int *need_sp)
{
	int	allzero;
	int	i;
...
static int	process_scale(t_dict *dict, char *num_str,
	const char *scale, int *need_sp)
{
	char	*head;
	char	*tail;
	int		h;
